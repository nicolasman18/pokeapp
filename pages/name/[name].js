...
import {Card, Container, Grid, Image, Text, Popover, Button, Spacer, Pagination as UIPagination, Row,} from "@nextui-org/react";
...
const PokemonByNamePage = ({ pokemon }) => {
  ...
  return (
    ...
    >
      <Grid.Container css={{ marginTop: "5px" }} gap={16}>
        <Grid xs={12} sm={4}>
          <Card isHoverable css={{ padding: "30px" }} gap={16}>
            <Card.Body
              css={{
                display: "flex",
        ...
        <Grid xs={12} sm={8}>
          <Card>
            ...
            <Card.Body>
              ...
              <Container direction="row" display="flex" gap={16}>
                <Image
